 ...
 */
const Avatar = React.memo(({ source, alt = 'Avatar', classes = '', width, height }: AvatarProps) => {
  if (source) {
    return (
      <img
        src={source}
  ...
  return (
    <FaUser
      className={clsx('rounded-full border-2 text-white bg-[#A6A6A6] border-accent1 text-7xl', classes)}
      role="img"
